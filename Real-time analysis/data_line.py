...
# =============================================================================
    ...
    def CO2Concetration(self):
        ...
        if 1 - NRcomp > 0:
            Conc_CO2= ((-1/a)*np.ln(1-(1-NRcomp)/Scomp)) **(1/n)
        else:
            Conc_CO2= -((-1/a)*np.ln((1-(1-NRcomp)*(-1)/Scomp)) **(1/n)  ## το ειδα στις οδηγιες, αν δε το θυμηθω πες να το συζητησουμε
        
        return Conc_CO2 #giati error?
